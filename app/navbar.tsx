...
import { Crop, FileSearch, FileVideo, Image as ImageIcon, Type, Copy, BookOpen, FileDown, FlipHorizontal2 } from "lucide-react";
...
const navItems = [
  ...
  { name: 'Blueprint Mirror', href: '/blueprint-mirror', icon: FlipHorizontal2 },
];
